...
function question7() {
  ...
  do {
    var countryQuestion = prompt('What is one country I\'ve been to outside of the USA? You have ' + (6 - counter) + ' tries to guess one right!').toLowerCase();

    if(countryQuestion === 'mexico' || countryQuestion === 'canada' || countryQuestion === 'aruba' || countryQuestion === 'france'){
      alert('Nice work!');
      break;
    } else {
      counter += 1;
  ...
  } while (countryQuestion !== 'mexico' || countryQuestion !== 'canada' || countryQuestion !== 'aruba' || countryQuestion !== 'france');
}
